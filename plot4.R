...
legendText= paste("Sub_metering_", 1:3)
plot (dt, sm1, type="l", col=colors[1], ylab="Energy Sub metering", xlab="")
lines(dt, sm2, type="l", col=colors[2])
lines(dt, sm3, type="l", col=colors[3])
legend("topright", legendText, lty=1, col=colors)
